...
$ L_{DR}(\phi, \theta) = \frac{1}{\vert D \vert }\sum_{(u,i) \in D} \left[ \hat{e}_ {u,i} + \frac{o_ {u,i}(e_ {u,i} - \hat{e}_ {u,i} )}{\hat{p}_ {u,i}}  \right] $ 이다. 
