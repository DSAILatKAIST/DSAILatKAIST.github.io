...
<p align="center"><img src="/images/Relational_Message_Passing_for_Knowledge_Graph_Completion/Figure.png" width="600" height="400"></p>
...
$p(t \vert h,r)$, $p(h \vert t,r)$는 entity와 relation이 주어졌을때 다른 entity에 어떻게 도착할지에 대한 likelihood입니다. 이는 entity와 entity 사이의 **경로**를 모델링하는 문제가 됩니다.
...
4. context representation과  더해서  softmax을  적용합니다. 실제  relation와 predicted relation의  차이에  대해  cross entropy loss를  최소화하는  relation을  구합니다.
    ...
    $p(r \vert h, t)=SOFTMAX(s_{(h,t)}+s_{h \rightarrow t})$ 
