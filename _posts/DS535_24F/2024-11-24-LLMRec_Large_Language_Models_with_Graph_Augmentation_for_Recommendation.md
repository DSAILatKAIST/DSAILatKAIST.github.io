...
permalink: 2024-11-24-LLMRec_Large_Language_Models_with_Graph_Augmentation_for_Recommendation.html
tags: [reviews]
use_math: true
usemathjax: true
---
...
- **Objective**:
  To enhance the learning process, LLMRec aims to maximize the posterior probability of the embeddings $ E = \lbrace E_ u, E_ i \rbrace \)$ given the original and augmented interactions:
...
![image_name](https://i.postimg.cc/630F1s6d/table-1.png)
